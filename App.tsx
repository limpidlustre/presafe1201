      ...
      <div className="min-h-screen bg-slate-50 font-sans text-slate-800 flex flex-col">
        ...
        <nav className="bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-40">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-full transition-all text-sm font-semibold border border-slate-200"
            >
        ...
        <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
          ...
          <section className="text-center space-y-6">
            ...
            <div className="flex flex-wrap justify-center gap-4">
                <a 
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 bg-white hover:bg-blue-50 border border-slate-200 hover:border-blue-200 rounded-full text-sm font-medium text-slate-600 hover:text-blue-700 transition-all shadow-sm hover:shadow group"
                >
                  <span className="w-2 h-2 bg-blue-400 rounded-full group-hover:animate-pulse"></span>
                  山东省食用农产品和食品信息化追溯平台
                  <svg className="w-4 h-4 text-slate-300 group-hover:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                </a>
                <a 
                  href="http://117.73.254.122:8099/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-5 py-2.5 bg-white hover:bg-cyan-50 border border-slate-200 hover:border-cyan-200 rounded-full text-sm font-medium text-slate-600 hover:text-cyan-700 transition-all shadow-sm hover:shadow group"
                >
                  <span className="w-2 h-2 bg-cyan-400 rounded-full group-hover:animate-pulse"></span>
                  山东冷链食品疫情防控管理系统
                  <svg className="w-4 h-4 text-slate-300 group-hover:text-cyan-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                </a>
            </div>
          </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
            ...
            <div className="lg:col-span-4 h-[500px] lg:h-[calc(100vh-320px)] lg:min-h-[500px] sticky top-24">
